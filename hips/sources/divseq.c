...
/*
 * divseq.c - divide images pixel by pixel
 *
 * usage:	divseq seq1 <seq2 >oseq
 *
 * to load:	cc -o divseq divseq.c -lhipsh -lhips
 *
 *
 * The region-of-interest of seq2 is divided by the region-of-interest of
 * seq1, and then seq1 with that quotient replacing its ROI is output.
...

{
	...
	int method1,method2,fr,fr1,fr2,f,ofmt,savesize,tmpfmt,totzdiv=0;
	...
	if (totzdiv)
		fprintf(stderr,"%s: Total of %d divisions by zero\n",Progname,
			totzdiv);
	return(0);
}
