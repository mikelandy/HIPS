...
/*
 * htobgrz - convert to BGRZ pixel format
 *
 * usage:	htobgrz <iseq >oseq
 *
 * Convert from any pixel format to BGRZ format.
 *
 * to load:	cc -o htobgrz htobgrz.c -lhips -lm
 *
