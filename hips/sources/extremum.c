...
/*
 * extremum - apply a extremum filter to an image
 *
 * usage:	extremum [-s size]
 *
 * where size is the length of the side of the neighborhood in which the
 * extremum is computed.  Size defaults to 3.
 *
 * to load:	cc -o extremum extremum.c -lhipsh -lhips -lm
 *
 * Mike Landy - 5/28/82
 * HIPS 2 - msl - 6/16/91
 */
