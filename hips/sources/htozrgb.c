...
/*
 * htozrgb - convert to ZRGB pixel format
 *
 * usage:	htozrgb <iseq >oseq
 *
 * Convert from any pixel format to ZRGB format.
 *
 * to load:	cc -o htozrgb htozrgb.c -lhips -lm
 *
