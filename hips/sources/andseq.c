...
/*
 * andseq.c - compute the logical AND of two sequences
 *
 * usage:	andseq file <iseq >oseq
 *
 * to load:	cc -o andseq andseq.c -lhipsh -lhips
 *
 * The region-of-interest of file is anded with the region-of-interest of iseq,
