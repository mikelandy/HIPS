...
/*
 * htorgbz - convert to RGBZ pixel format
 *
 * usage:	htorgbz <iseq >oseq
 *
 * Convert from any pixel format to RGBZ format.
 *
 * to load:	cc -o htorgbz htorgbz.c -lhips -lm
 *
