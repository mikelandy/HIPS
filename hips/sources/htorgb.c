...
/*
 * htorgb - convert to RGB pixel format
 *
 * usage:	htorgb <iseq >oseq
 *
 * Convert from any pixel format to RGB format.
 *
 * to load:	cc -o htorgb htorgb.c -lhips -lm
 *
