 ...
 *
 * usage:	htod <iseq >oseq
 *
 * Convert from any pixel format to double precision floating point format.
 *
 * to load:	cc -o htod htod.c -lhips -lm
 *
 * Mike Landy - 1/8/91
 */
