...
/*
 * maxseq.c - compute the maximum of two images pixel by pixel
 *
 * usage:	maxseq file <iseq >oseq
 *
 * to load:	cc -o maxseq maxseq.c -lhipsh -lhips
 *
 ...
 *
 * Types handled directly: BYTE, SHORT, INT, FLOAT, DOUBLE, INTPYR, FLOATPYR
 *
...
int types[] = {PFBYTE,PFSHORT,PFINT,PFFLOAT,PFDOUBLE,PFINTPYR,
		PFFLOATPYR,LASTTYPE};
