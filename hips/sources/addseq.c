...
/*
 * addseq.c - add images pixel by pixel
 *
 * usage:	addseq file <iseq >oseq
 *
 * to load:	cc -o addseq addseq.c -lhipsh -lhips
 *
 * The region-of-interest of file is added to the region-of-interest of iseq,
 * then iseq with that sum replacing its region-of-interest is output.
