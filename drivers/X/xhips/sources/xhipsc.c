 ...
 *
 * Changed window title bar to display image name - Carlo Tiana 3/15/95
...

{
	...
	if (debug_flag)
		for (i=0;i<ncolors;i++) {
			...
			fprintf(stderr,
				"color[%3d]: pix %3lu r= %5u g= %5u b= %5u\n",i,
...
void ReadClutFile(fileName,clrs)
