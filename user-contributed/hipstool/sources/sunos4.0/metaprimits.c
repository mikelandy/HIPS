...
/*  { name, loc_size, data_type, drag_create,
    select, modify, display } */
    { "line", 2, DATA_TRACE, 0,	/* drag_create set to 1 for CLICK_AND_DRAG */
	  line_select, line_modify, primit_display_line },
    { "box", 2, DATA_BOX, 1,
	  box_select, box_modify, primit_display_box },
    { "open spline", VARIES, DATA_TRACE, 0,
	  list_select, list_modify, primit_display_open_spline },
    { "closed spline", VARIES, DATA_NONE, 0,
	  list_select, list_modify, primit_display_closed_spline },
    { "polygon", VARIES, DATA_NONE, 0,
	  list_select, list_modify, primit_display_polygon },
    { "point", 1, DATA_CROSS, 1,
	  point_select, point_modify, primit_display_point },
    { "text", 1, DATA_TEXT, 0,
	  text_select, text_modify, primit_display_text },
};
     ...
     va_dcl
{
    ...
    breed = va_arg(index, enum primit);
