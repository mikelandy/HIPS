...
void updatecolormap()
{
  red[BG_COLORM]= green[BG_COLORM]= blue[BG_COLORM]= grimBGcolor;
  red[FG_COLORM]= green[FG_COLORM]= blue[FG_COLORM]= grimFGcolor;
  red[0]= green[0]= blue[0]=grimBGcolor;
  red[BG_COLORM-1]= green[BG_COLORM-1]= blue[BG_COLORM-1]= grimFGcolor;
