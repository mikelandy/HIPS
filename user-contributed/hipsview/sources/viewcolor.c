/*
  cc -o viewcolor  -O  viewcolor.c -lsuntool -lsunwindow -lpixrect
  exit
*/
...
int invertgraymap = 0;
int viewFGcolor, viewBGcolor;
unsigned char red[CMS_SIZE], green[CMS_SIZE], blue[CMS_SIZE]; 

char fname[80];
char lable1[80] = { 'v','i','e','w','c','o','l','o','r',':' ,' ' };
char lable2[80];
char clear_line[] = { '\r',
' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',' ',
...
void updatecolormap()
{
  red[BG_COLORM]= green[BG_COLORM]= blue[BG_COLORM]= viewBGcolor;
  red[FG_COLORM]= green[FG_COLORM]= blue[FG_COLORM]= viewFGcolor;
  red[0]= green[0]= blue[0]=viewBGcolor;
  red[BG_COLORM-1]= green[BG_COLORM-1]= blue[BG_COLORM-1]= viewFGcolor;
  pw_putcolormap(canvas_pw, 0, CMS_SIZE, red, green, blue);
}
