...
void usageterm(),alloc_stack(),alloc_point_list(),push(),pop();
void add_to_point_list();
...
/***************************************************************/
void alloc_stack(st_size)	/* allocation stack for non-recursive
				 * flood-fill alg */
    int       st_size;
{
...
/**************************************************************/
void alloc_point_list(st_size)	/* allocation stack for non-recursive
				 * flood-fill alg */
    int       st_size;
{
