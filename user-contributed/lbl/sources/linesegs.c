...
float     angle_diff;
char     *fname;
void parse_args(),find_endpoint(),follow_line(),usageterm();
int count_neighbors(),list_is_empty();
...
/*******************************************************/
void find_endpoint(x, y)	/* find an end of a line in the image */
    int      *x, *y;
{
    register int i, j;
