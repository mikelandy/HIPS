...
#define pgm_allocrow( cols ) ((gray*) nzalloc( cols, sizeof(gray), "pgm-row"))
...
int pgm_readpgminit ARGS(( FILE* file, int* colsP, int* rowsP, gray* maxvalP, int* formatP ));
int pgm_readpgmrow ARGS(( FILE* file, gray* grayrow, int cols, gray maxval, int format ));
