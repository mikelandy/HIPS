...
*      Grab a 512x512 image P10 -> LS and freeze                          *
*      Display  a frozen 512x512 frame LS -> P7    		              *
*                                                                         *
***************************************************************************
*
 ...
 * 512x512 frame from the P10 port. P10 -> LS
 */
/* Timing a write ROI sequence  Vlen =(frame req. / 2) for interlace mode  */
    rsWHST(rsfd, 0x5A);			/* Set Write Roi Horizontal Start   */
    rsWHET(rsfd, 0x25A);			/* Set Write Roi Horizontal End   */
 ...
 * 512x512 frame from the P7 port. LS -> P7
 */
/* Timing a ROI sequence   */
    rsRHST(rsfd, 0x50);			/* Set Read  Roi Horizontal Start 88 */
    rsRHET(rsfd, 0x250);			/* Set Read  Roi Horizontal End 600  */
    rsRVST(rsfd, 0x14);			/* Set Read  Roi Vertical Start 20   */
    rsRVET(rsfd, 0x114);			/* Set Read  Roi Vertical End    261  */
/* Control parameters for memory Hlen 1024 Finc 512 for interlace mode  */
