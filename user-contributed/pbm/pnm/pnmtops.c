...
static void putinit ARGS(( char* name, int cols, int rows, int padright, int bps, float scale, int dpi, int pagewid, int pagehgt, int format, int rleflag ));
...
main( argc, argv )
    ...
    char name[100];
    char* cp;
    char* usage = "[-rle|-runlength] [-scale <x>] [-dpi <n>] [-width <n>] [-height <n>] [pnmfile]";
...
#if __STDC__
static void
putinit( char* name, int cols, int rows, int padright, int bps, float scale, int dpi, int pagewid, int pagehgt, int format, int rleflag )
#else /*__STDC__*/
static void
putinit( name, cols, rows, padright, bps, scale, dpi, pagewid, pagehgt, format, rleflag )
    char* name;
    int cols, rows, padright, bps;
    float scale;
    int dpi, pagewid, pagehgt, format, rleflag;
#endif /*__STDC__*/
    {
    int devpix;
