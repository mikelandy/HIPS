/* fsuntovax.c - converts single precision numbers from sun format to vax
 * format. It should work on either a sun or a vax, since it just uses byte
 * manipulations.
 *
 * usage: fsuntovax <floatin.hpl > floatout.hpl
 *
 * to load: cc -o fsuntovax fsuntovax.c -O -lhips
 *
