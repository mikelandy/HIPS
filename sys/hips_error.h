...
struct h_errstruct {		/* the error structure defined in herrs.c */
...
#define	HE_SHORTBUF 104 /* "%s: encoded buffer terminates too early" */
#define	HE_SHORTOBUF 105 /* "%s: output buffer is too small" */
#define MAXERR 105
