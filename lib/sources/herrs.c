...
{"mismatched number of depths, file: %s",HEP_S,HEL_ERROR},/* HE_C_DEPTH 101 */
{"mismatched number of depths and numcolor>1 or numdepth>1, file: %s",
	HEP_S,HEL_ERROR},				/* HE_C_DPTHC 102 */
{"bad value of depth, should be > 0",HEP_N,HEL_ERROR},	/* HE_BADDEPTH 103 */
{"%s: encoded buffer terminates too early",HEP_S,HEL_ERROR},
							/* HE_SHORTBUF 104 */
{"%s: output buffer is too small",HEP_S,HEL_ERROR},	/* HE_SHORTOBUF 105 */
